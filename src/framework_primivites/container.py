...
class Container(MarionettePrimitive):
    ...
    def partial_wire_dependencies(cls, obj_to_wire_up, *dependencies_to_ignore, scope_overwrite="function"):
        ...
        dependency_obj = Dependency.get_dependency_without_decoration(obj_to_wire_up, scope_overwrite)
        resolved_dependencies = DependencyGraphManager.resolve_dependencies(dependency_obj, ScopeKey(dependency_obj.dependency_obj, scope_overwrite), *dependencies_to_ignore)
