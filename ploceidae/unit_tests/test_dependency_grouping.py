...
class TestDependencyGrouping:
    def test_grouped_dependencies_are_resolved_to_dependent(self, dependency_decorator):
    ...
    def test_dependencies_that_are_grouped_can_be_resolved_with_normal_dependencies(self, dependency_decorator):
        @dependency_decorator(group="deps", global_dependency=True)
        def a():
            return "a"
    ...
    def test_dependency_that_is_both_grouped_and_normal(self, dependency_decorator):
        @dependency_decorator(group="deps", global_dependency=True)
        def a():
            return "a"
    ...
    def test_dependency_that_is_grouped_can_be_resolved_independently_of_group(self, dependency_decorator):
        @dependency_decorator(group="deps", global_dependency=True)
        def a():
            return "a"
